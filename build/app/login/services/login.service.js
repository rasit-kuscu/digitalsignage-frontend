System.register(['@angular/core', '@angular/http', '../../common/headers', '../../common/services/shared.service', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, headers_1, shared_service_1;
    var LoginService;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            LoginService = (function () {
                function LoginService(http, _sharedService) {
                    this.http = http;
