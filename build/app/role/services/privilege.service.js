System.register(['@angular/core', 'angular2-jwt', '../../common/services/shared.service', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            PrivilegeService = (function () {
                function PrivilegeService(authHttp, _sharedService) {
                    this.authHttp = authHttp;
                    this._sharedService = _sharedService;
                }
                PrivilegeService.prototype.load = function () {
            ...
            exports_1("PrivilegeService", PrivilegeService);
        }
    }
});
