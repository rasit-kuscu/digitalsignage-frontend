System.register(["@angular/core", '@angular/router', '@angular/forms', 'notifications', '../../common/services/validation.service', '../../common/components/loader.animation', '../../common/components/control.messages', '../services/user.service', '../models/user', '../../group/services/group.service', '../../role/services/role.service', 'rxjs/add/operator/map', 'rxjs/Observable'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, forms_1, notifications_1, validation_service_1, loader_animation_1, control_messages_1, user_service_1, user_1, group_service_1, role_service_1, Observable_1;
            ...
            UserEditComponent = (function () {
                ...
                UserEditComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_1.ROUTER_DIRECTIVES, forms_1.REACTIVE_FORM_DIRECTIVES, notifications_1.SimpleNotificationsComponent, control_messages_1.ControlMessages, loader_animation_1.LoaderAnimation],
                    ...
                    __metadata('design:paramtypes', [(typeof (_a = typeof user_service_1.UserService !== 'undefined' && user_service_1.UserService) === 'function' && _a) || Object, group_service_1.GroupService, role_service_1.RoleService, forms_1.FormBuilder, (typeof (_b = typeof notifications_1.NotificationsService !== 'undefined' && notifications_1.NotificationsService) === 'function' && _b) || Object, router_1.Router, router_1.ActivatedRoute])
                ], UserEditComponent);
