System.register(["@angular/core", '@angular/router', '../../common/services/shared.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            UserMainComponent = (function () {
                function UserMainComponent(router, activatedRoute, _sharedService) {
                    var _this = this;
                    this.router = router;
                ...
                UserMainComponent = __decorate([
                    core_1.Component({
                        selector: "user-main",
                        templateUrl: "./app/user/components/user.main.html",
                        directives: [router_1.ROUTER_DIRECTIVES]
                    }), 
                    __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, (typeof (_a = typeof shared_service_1.SharedService !== 'undefined' && shared_service_1.SharedService) === 'function' && _a) || Object])
                ], UserMainComponent);
                return UserMainComponent;
                var _a;
            }());
            exports_1("UserMainComponent", UserMainComponent);
        }
    }
});
